...
namespace ConsoleApp.Services
{
    public class MainService : IMainService
    {
        ...
        public void Run()
        {
            ...
            _lineService.InitLines(sourceLines);
            ...
            var indexesWithInvalidLine = _lineService.FindIndexesWithInvalidLine();
            _consoleService.PrintResults(indexWithMaxSum, indexesWithInvalidLine);
        }
    }
}